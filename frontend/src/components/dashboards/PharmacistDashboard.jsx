        ...
        <div className="dash-sidebar-footer">
          <div className="dash-user-profile-summary">
            <div className="dash-user-avatar">
              {getInitials(user?.FullName || 'Pharmacist')}
            </div>
            <div className="dash-user-details">
              <h5>{user?.FullName || 'Pharmacist'}</h5>
              <p>{user?.Email || 'pharmacist@apexhealth.org'}</p>
            </div>
          </div>
      ...
      <main className="dash-main-content">
        ...
        <div className="dash-hero-banner">
          <div className="dash-hero-banner-content">
            ...
            <h2>Welcome back, {user?.FullName || 'Pharmacist'}</h2>
            <p>
              Apex Health International Hospital live operations overview. Fulfill physician e-prescriptions, track medicine stock items, and process drug refills.
            </p>
          </div>

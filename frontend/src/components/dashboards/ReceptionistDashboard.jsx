      ...
      <main className="dash-main-content">
        ...
        <div className="dash-hero-banner">
          <div className="dash-hero-banner-content">
            ...
            <p>
              Apex Health International Hospital live operations overview. Track bed occupancy, clinical staff schedules, revenue metrics, and patient care streams.
            </p>
          </div>
        ...
        <div className="dash-stats-grid">
          ...
          <div className="dash-stat-card">
            <div className="dash-stat-info">
              ...
              <h3>6</h3>
              <p>
                Registered Patients <strong style={{ color: '#10b981', marginLeft: 'auto' }}>↑ 12%</strong>
              </p>
            </div>
          ...
          <div className="dash-stat-card">
            <div className="dash-stat-info">
              ...
              <h3>LKR 1,169.81</h3>
              <p>
                Settled Invoices <strong style={{ color: '#10b981', marginLeft: 'auto' }}>↑ 100%</strong>
              </p>
            </div>

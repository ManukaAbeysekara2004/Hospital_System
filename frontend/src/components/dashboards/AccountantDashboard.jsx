        ...
        <div className="dash-sidebar-footer">
          <div className="dash-user-profile-summary">
            <div className="dash-user-avatar">
              {getInitials(user?.FullName || 'Accountant')}
            </div>
            <div className="dash-user-details">
              <h5>{user?.FullName || 'Accountant'}</h5>
              <p>{user?.Email || 'accountant@apexhealth.org'}</p>
            </div>
          </div>
      ...
      <main className="dash-main-content">
        ...
        <div className="dash-hero-banner">
          <div className="dash-hero-banner-content">
            ...
            <h2>Welcome back, {user?.FullName || 'Accountant'}</h2>
            <p>
              Apex Health International Hospital live operations overview. Track patient billing statements, cleared receipts, revenue metrics, & financial streams.
            </p>
          </div>

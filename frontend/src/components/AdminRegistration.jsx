...
export default function AdminRegistration({ onBackToRoles, onBackToLogin }) {
  const [step, setStep] = useState(1); // 1: Personal Info, 2: Administrative Info, 3: Account Setup
  ...
  const [dobYear, setDobYear] = useState('1980');
  ...
  const handleNextStep2 = (e) => {
    ...
    if (!hospitalBranch.trim()) {
      setErrorMessage('Please enter your Hospital Branch.');
      return;
    }
  ...
  const handleFinalSubmit = async (e) => {
    ...
    if (!trimmedEmail.endsWith('@gmail.com')) {
      setErrorMessage('Email address must end with @gmail.com (e.g. admin@gmail.com).');
      return;
    }
    ...
    const adminData = {
      ...
      HospitalBranch: hospitalBranch.trim(),
      Email: trimmedEmail,
      Password: password
    };
    ...
    try {
      ...
      if (response.ok) {
        setIsLoading(false);
        setRegisteredAdmin(adminData);
        setSuccessModal(true);
      } else {
        setIsLoading(false);
        setErrorMessage(resData.message || resData.error || 'Admin registration failed. Please check your inputs.');
      }
    } catch (err) {
  ...
  return (
    <div className="login-card animate-fade-in" style={{ gridTemplateColumns: '1fr', maxWidth: '980px' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            ...
            <div className="stepper-pills">
              ...
              <span className={`step-pill ${step >= 2 ? 'active' : ''}`}>2. Administrative</span>
              <span className="step-line"></span>
          ...
          <div className="auth-header" style={{ marginBottom: '24px' }}>
            ...
            <p className="auth-subtitle">
              {step === 1 && 'Provide your personal details & contact information as system administrator.'}
              {step === 2 && 'Specify your Admin ID, administrative department, & hospital branch location.'}
              {step === 3 && 'Setup your official hospital email (@gmail.com) & secure administrator password.'}
            </p>
          </div>
          ...
          {step === 1 && (
            <form className="auth-form animate-fade-in" onSubmit={handleNextStep1}>
              <div className="input-group">
                <label className="input-label" htmlFor="adminFullName">Full Name</label>
                <div className="input-field-wrapper">
                  ...
                  <input
                    ...
                    placeholder="e.g. Administrator Marcus Sterling"
                    value={fullName}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div className="input-group">
                  <label className="input-label" htmlFor="adminGender">Gender</label>
                  <div className="input-field-wrapper">
                    <select
                      id="adminGender"
                      className="input-field"
                ...
                <div className="input-group">
                  <label className="input-label" htmlFor="adminNIC">NIC Number</label>
                  <div className="input-field-wrapper">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div className="input-group">
                  <label className="input-label" htmlFor="adminPhone">Phone Number (Must be 10 digits)</label>
                  <div className="input-field-wrapper">
                ...
                <div className="input-group">
                  <label className="input-label" htmlFor="adminAddress">Address</label>
                  <div className="input-field-wrapper">
                    ...
                    <input
                      ...
                      type="text"
                      className="input-field"
                      placeholder="e.g. Apex Central Admin Suite, Colombo"
                      value={address}
              ...
              >
                Next to Administrative Information
                <ArrowRight size={20} />
              </button>
            </form>
          )}

          {/* STAGE 2 FORM: ADMINISTRATIVE INFORMATION */}
          {step === 2 && (
            <form className="auth-form animate-fade-in" onSubmit={handleNextStep2}>
              <div className="input-group">
                <label className="input-label" htmlFor="adminIDVal">Admin ID</label>
                <div className="input-field-wrapper">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div className="input-group">
                  <label className="input-label" htmlFor="adminDept">Department</label>
                  <div className="input-field-wrapper">
                    ...
                    <input
                      ...
                      type="text"
                      className="input-field"
                      placeholder="e.g. Executive Hospital Management"
                      value={department}
                ...
                <div className="input-group">
                  <label className="input-label" htmlFor="adminBranch">Hospital Branch</label>
                  <div className="input-field-wrapper">
                    ...
                    <input
                      ...
                      type="text"
                      className="input-field"
                      placeholder="e.g. Apex Main Hospital - Colombo"
          ...
          {step === 3 && (
            <form className="auth-form animate-fade-in" onSubmit={handleFinalSubmit}>
              <div className="input-group">
                ...
                <div className="input-field-wrapper">
                  ...
                  <input
                    ...
                    type="email"
                    className="input-field"
                    placeholder="e.g. admin.sterling@gmail.com"
                    value={email}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div className="input-group">
                  <label className="input-label" htmlFor="adminPwd">Password</label>
                  <div className="input-field-wrapper">
                ...
                <div className="input-group">
                  <label className="input-label" htmlFor="adminCpwd">Confirm Password</label>
                  <div className="input-field-wrapper">
              ...
              <div style={{ background: 'var(--bg-input)', border: '1px solid var(--border-color)', borderRadius: '10px', padding: '16px', fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                ...
                <div>• Department: <strong style={{ color: '#0284c7' }}>{department || 'N/A'}</strong> | Branch: <strong style={{ color: 'var(--text-main)' }}>{hospitalBranch || 'N/A'}</strong></div>
                <div>• Admin ID: <strong style={{ color: 'var(--text-main)' }}>{adminID || 'N/A'}</strong></div>
              </div>
      ...
      {/* SUCCESS MODAL AFTER ADMIN REGISTRATION */}
      {successModal && registeredAdmin && (
        <div className="modal-overlay animate-fade-in">
          <div className="modal-content">
            ...
            <p>
              Administrator <strong>{registeredAdmin.FullName}</strong> has been registered under <strong>{registeredAdmin.Department}</strong>.
            </p>
            ...
            <div style={{ background: 'var(--bg-input)', padding: '16px', borderRadius: '10px', marginBottom: '24px', fontSize: '0.88rem', textAlign: 'left', color: 'var(--text-muted)' }}>
              <div style={{ marginBottom: '4px' }}>• Admin ID: <span style={{ color: 'var(--text-main)', fontWeight: 'bold' }}>{registeredAdmin.AdminID}</span></div>
              <div style={{ marginBottom: '4px' }}>• Hospital Branch: <span style={{ color: 'var(--text-main)' }}>{registeredAdmin.HospitalBranch}</span></div>
              <div style={{ marginBottom: '4px' }}>• Phone: <span style={{ color: 'var(--text-main)' }}>{registeredAdmin.PhoneNumber}</span></div>
              <div style={{ marginBottom: '4px' }}>• Email: <span style={{ color: '#10b981', fontWeight: 'bold' }}>{registeredAdmin.Email}</span></div>
            </div>
